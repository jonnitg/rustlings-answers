...
mod tests {
    ...
    fn test_iterate_string_vec() {
        ...
        let capitalized_words: Vec<String> =
            words.iter().map(|word| capitalize_first(word)).collect(); // collect the vector into another vector of strings
    ...
    fn test_iterate_into_string() {
        ...
        let capitalized_words = words
            ...
            .collect::<String>(); // this is amazing!!! xD collect the vector into a String
        assert_eq!(capitalized_words, "Hello World");
    }
}
